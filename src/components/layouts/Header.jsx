  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
           ...
           ><Link to={'https://github.com/tituvai'}  target="_blank"><FiGithub className='text-gray-300 hover:text-green-600 transition-colors duration-300 w-5 h-5'/></Link>
           </motion.span>
           <motion.span 
           initial={{opacity: 0, scale: 0.5}}
           animate={{opacity: 1, scale: 1}}
           ...
           animate={{opacity: 1, scale: 1}}
           transition={{delay: 1.3, duration: 0.8}}
           ><Link to={'https://www.linkedin.com/in/titu-sarkar-464878322'} target="_blank">< FiLinkedin className='text-gray-300  hover:text-green-600 transition-colors duration-300 w-5 h-5'/></Link>
           </motion.span>
        ...
        className="md:hidden overflow-hidden bg-gray-900 dark:bg-white shadow-lg px-4 py-5 gap-y-5">
          ...
          <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
            <div className="flex gap-x-5">
              <Link to={'https://github.com/tituvai'} target="_blank"><FiGithub className='h-5 w-5 text-gray-300'/></Link>
              <Link to={'/'}><FiTwitter className='h-5 w-5 text-gray-300'/></Link>
              <Link to={'https://www.linkedin.com/in/titu-sarkar-464878322'} target="_blank"><FiLinkedin className='h-5 w-5 text-gray-300'/></Link>
            </div>
          </div>
